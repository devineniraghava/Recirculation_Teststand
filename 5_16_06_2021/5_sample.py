...
# 
# location = "C:/Users/Raghavakrishna/OneDrive - bwedu/6_Recirculation_Teststand/5_17_06_2021/excel data"
# 
# abs_path = []
# 
...
# co2_df.to_excel("save5.xlsx") # manually removed unnecessary data in excel sheet
# =============================================================================
#%%
...
# df = px.data.stocks()
df = pd.read_excel("save5.xlsx")
df = df[sorted(df.columns)]
df2 = df.fillna(0)



fig = px.line(df2, x="datetime", y=df.columns, title='Outdoor: 20°C , 60 %RH  Indoor: 2°C, 34 %RH1) 60 m3/hr , and 2) 80 m3/hr')
fig.show()
