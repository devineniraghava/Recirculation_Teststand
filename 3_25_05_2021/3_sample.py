...
# =============================================================================
# location = "C:/Users/Raghavakrishna/OneDrive - bwedu/6_Recirculation_Teststand/3_25_05_2021/excel data"
# 
# abs_path = []
# 
...
# df = px.data.stocks()
df = pd.read_excel("save3.xlsx")
df = df[sorted(df.columns)]
df2 = df.fillna(0)



fig = px.line(df2, x="datetime", y=df.columns, title='160 m3/hr (Tuesday), 1) Entire AC closed loop and 2) Test stand closed loop')
fig.show()
