...
#%%
# =============================================================================
# sensor_list = ['1a_50','1T', '2a_50', '2c_50', '2d','2e', '2L','2T', '3b', 
#                '3g', '3h','3L_Kü', 'außen', '4L', '4T']
...
# 
# location = "C:/Users/Raghavakrishna/OneDrive - bwedu/6_Recirculation_Teststand/10_10_08_2021/excel files"
# 
# abs_path = []
# 
...
# df = px.data.stocks()
df = pd.read_excel("save10.xlsx")
df = df[sorted(df.columns)]
df2 = df.fillna(0)



fig = px.line(df2, x="datetime", y=df.columns, title='Needs a title no protokol found')
fig.show()
